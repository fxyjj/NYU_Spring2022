...
if __name__ == "__main__":
    ...
    print("C5 <N>:",n," ,<T>: ",(overall_time),"sec, <B>: ",(2*n+1)*4*k/((overall_time)*1000000000),"Gb/s,F: ",2*n*k/(1000000000*overall_time),"GFLOP/s")
    print("C5 <N>:",n,", <T>: ",second_half*2/k,"sec, <B>: ",bw*2/k,"Gb/s, <F>:",flop*2/k,"GFLOP/s")
